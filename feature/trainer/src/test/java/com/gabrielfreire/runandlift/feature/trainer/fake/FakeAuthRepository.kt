 ...
 * treinador que tente criar conta é erro de arquitetura, e o teste deve dizê-lo em voz alta em vez de
...
internal class FakeAuthRepository(private val signedIn: UserAccount? = ACCOUNT) : AuthRepository {
    ...
    private fun unsupported(): Nothing = error("o módulo do treinador não autentica ninguém")

    companion object {
        val ACCOUNT = UserAccount(uid = "u1", email = "carlos@exemplo.com", isEmailVerified = true)
    }
}
