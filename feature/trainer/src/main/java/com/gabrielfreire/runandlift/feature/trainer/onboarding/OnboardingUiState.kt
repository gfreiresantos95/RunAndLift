...
/**
 * Estado do passo a passo do treinador.
 *
 * @param step o passo na tela.
 * @param position posição dele na sequência, a partir de 1 — é o "passo 2 de 5" do cabeçalho.
 * @param total quantos passos a sequência tem **agora**. Cresce de cinco para sete quando o aceite
 *   da vitrine é dado, porque aí passam a existir perguntas que antes não cabia fazer.
...
internal data class OnboardingUiState(
    val step: OnboardingStep = OnboardingStep.EXPERIENCE,
    val position: Int = 1,
