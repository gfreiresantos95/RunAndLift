...
import com.gabrielfreire.runandlift.feature.trainer.location.PickedLocationEffect
...
internal fun AccountDestination(
    ...
    AccountScreen(
        ...
        actions = AccountActions(
            ...
            onOpenStatePicker = { navController.navigate(TrainerRoutes.STATE_PICKER) },
            ...
            onOpenCityPicker = {
                state.stateUf.takeIf { it.isNotEmpty() }
                    ?.let { navController.navigate(TrainerRoutes.cityPicker(it)) }
            },
