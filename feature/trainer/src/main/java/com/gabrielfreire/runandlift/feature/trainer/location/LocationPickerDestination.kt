...
private fun pickerTexts(listingCities: Boolean) = AppPickerTexts(
    title = stringResource(
        if (listingCities) R.string.trainer_city_picker_title else R.string.trainer_state_picker_title,
    ),
    searchLabel = stringResource(
        if (listingCities) R.string.trainer_city_picker_search else R.string.trainer_state_picker_search,
    ),
    clearSearch = stringResource(R.string.trainer_picker_clear),
    empty = stringResource(
        if (listingCities) R.string.trainer_city_picker_empty else R.string.trainer_state_picker_empty,
    ),
    failure = stringResource(R.string.trainer_picker_failure),
    retry = stringResource(R.string.trainer_picker_retry),
    back = stringResource(R.string.trainer_action_back),
)
