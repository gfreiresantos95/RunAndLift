 ...
 *
 * Agrupado porque atravessam o grafo inteiro juntos: soltos, cada assinatura repetiria a mesma
 * lista, e nenhum deles significa alguma coisa isolado do fluxo de entrada.
 */
@Immutable
