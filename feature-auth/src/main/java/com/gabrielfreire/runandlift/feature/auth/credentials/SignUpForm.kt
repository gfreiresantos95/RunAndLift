 ...
 * funcionar ([SignUpContactFields]), e só no fim o que a lei exige ([SignUpConsentFields]). Pedir
...
internal fun SignUpForm(
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        ...
        SignUpContactFields(form = form, formActions = formActions, role = role, enabled = enabled)
        ...
        SignUpConsentFields(form = form, formActions = formActions, enabled = enabled)
