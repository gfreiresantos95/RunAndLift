 ...
 */
internal fun SignUpFormState.toSignUpDetails(email: String?, isTrainer: Boolean) = SignUpDetails(
 ...
 */
internal fun SignUpFormState.toCompletionDetails(isTrainer: Boolean) = SignUpDetails(
    birthDate = AuthFormValidation.parseBirthDate(birthDate),
    phone = phone.ifEmpty { null },
    consent = PrivacyConsent(
        termsVersion = PrivacyConsent.CURRENT_TERMS_VERSION,
 ...
 */
internal fun SignUpFormState.prefilledFrom(profile: UserProfile?, registration: String?) = copy(
